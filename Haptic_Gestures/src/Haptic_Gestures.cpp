...
: m_kp{1.0}, m_kd{1.0}, torque_Mode{false},m_out{0.0,0.0}, max_distance{1.0}, latched_position{0.0}, relative_position{0.0} {

}
std_haptic_effect::std_haptic_effect(config_struct cf): 
config_file{cf}, torque_Mode{0}, m_out{0.0,0.0}, max_distance{1.0}, latched_position{0.0}, relative_position{0.0} { 
    
}
std_haptic_effect::std_haptic_effect(bool t_m)
: torque_Mode{t_m}, m_out{0.0,0.0}, max_distance{1.0}, latched_position{0.0}, relative_position{0.0} {

}
std_haptic_effect::std_haptic_effect(config_struct cf, bool t_m): 
config_file{cf}, torque_Mode{t_m}, m_out{0.0,0.0}, max_distance{1.0}, latched_position{0.0}, relative_position{0.0} { 
